...
namespace _xcsoft__ALL_IN_ONE.champions
{
    class Kalista
    {
        ...
        public static void Load()
        {
            ...
            Menu.SubMenu("Harass").AddItem(new MenuItem("harassMana", "if Mana % >", true).SetValue(new Slider(50, 0, 100)));
        ...
        static void Obj_AI_Hero_OnProcessSpellCast(Obj_AI_Base sender, GameObjectProcessSpellCastEventArgs args)
        {
            ...
            if (Menu.Item("soulboundsaver", true).GetValue<Boolean>() && R.IsReady())
            {
        ...
        static List<Obj_AI_Base> Q_GetCollisionMinions(Obj_AI_Hero source, SharpDX.Vector3 targetposition)
        {
